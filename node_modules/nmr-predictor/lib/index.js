...
exports.twoD = exports.spinus = exports.carbon = exports.proton = exports.setDb = exports.fetchCarbon = exports.fetchProton = undefined;
...
var _queryByHose = require('./queryByHose');

var _queryByHose2 = _interopRequireDefault(_queryByHose);

var _spinus = require('./spinus');

var _spinus2 = _interopRequireDefault(_spinus);

var _twoD = require('./twoD');

var _twoD2 = _interopRequireDefault(_twoD);
...
function fetch(url, dbName, type) {
  ...
  const fetching = _superagent2.default.get(url).then(res => {
...
function proton(molecule, options) {
  ...
  return (0, _queryByHose2.default)(molecule, db, options);
}
...
exports.fetchCarbon = fetchCarbon;
exports.setDb = setDb;
exports.proton = proton;
exports.carbon = carbon;
exports.spinus = _spinus2.default;
exports.twoD = _twoD2.default;