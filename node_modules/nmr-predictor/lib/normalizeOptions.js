...
var _getOcleFromOptions = require('./getOcleFromOptions');

var _getOcleFromOptions2 = _interopRequireDefault(_getOcleFromOptions);
...
function normalizeOptions(molecule, options) {
  ...
  let { Molecule, Util } = (0, _getOcleFromOptions2.default)(options); // (0, getOcleFromOptions.default)(options);
